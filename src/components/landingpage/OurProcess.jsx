...
export const OurProcess = () => {
   const processSteps = [
    ...
    },
    {
      ...
      description: "Creating sleek, functional, and user-friendly digital solutions.",
      icon: DesignIcon,
    },
    {
      ...
      <section className="absolute top-0 left-0 w-full h-full flex flex-col items-center pt-[10px] text-white bg-black/30">
        <div className="text-center max-w-2xl px-2">
          ...
          <span className="text-base leading-4">
            Our approach is collaborative and goal-oriented. We begin by understanding your needs, followed by planning, execution, and continuous feedback to ensure success.
          </span>
        </div>
       ...
       <div className='hidden sm:flex gap-8 pt-[40px]'>
        <div className="mt-8 bg-white bg-opacity-90 text-black h-[130px] relative top-30 w-[270px] pb-[40px] rounded-xl p-4 shadow-lg flex flex-col justify-center text-center">
          <Image src={processSteps[0].icon} alt="Icon" width={40} height={40} className='relative bottom-4 left-[40%]' />
          <h2 className="text-xl font-semibold pb-2">{processSteps[0].title}</h2>
          <p className='text-[16px]'>{processSteps[0].description}</p>
                ...
                <div className="mt-8 bg-white bg-opacity-90 text-black h-[130px] w-[270px] pb-[40px] rounded-xl p-4 shadow-lg flex flex-col justify-center text-center">
                 <Image src={processSteps[1].icon} alt="Icon" width={40} height={40} className='relative bottom-4 left-[40%]' />
          <h2 className="text-xl font-semibold pb-2">{processSteps[1].title}y</h2>
          <p className='text-[16px]'>{processSteps[1].description}</p>
                ...
                <div className="mt-8 bg-white bg-opacity-90 text-black h-[130px] relative top-30 w-[270px] rounded-xl p-4 pb-[40px] shadow-lg flex flex-col justify-center text-center">
                 <Image src={processSteps[2].icon} alt="Icon" width={40} height={40} className='relative bottom-4 left-[40%]' />
          <h2 className="text-xl font-semibold pb-2">{processSteps[2].title}</h2>
         <p className='text-[16px]'>{processSteps[2].description}</p>
                ...
                <Image src={processSteps[3].icon} alt="Icon" width={40} height={40} className='relative bottom-4 left-[40%]' />
          <h2 className="text-xl font-semibold pb-2">{processSteps[3].title}</h2>
